...
public class pastaRecipe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.pastarecipe);
        ...
        imageView = (ImageView)findViewById(R.id.lemon);
        ...
        bookmark_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    writeData("m003","투움바파스타","https://firebasestorage.googleapis.com/v0/b/androidproject-9def8.appspot.com/o/pasta.jpg?alt=media&token=1e6ac40f-2ff5-437d-9671-e715706edbc0" );
    ...
    public void writeData(String foodID, String foodName, String foodImg){
        ...
        databaseReference.child("BookMark").child("Food_10").setValue(bookmark);
    }
}
