...
public class stakeRecipe extends AppCompatActivity {
    TabLayout tabLayout;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.stakerecipe);
        ...
        imageView = (ImageView)findViewById(R.id.wine);
        ...
        bookmark_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    writeData("m002","목살스테이크","https://firebasestorage.googleapis.com/v0/b/androidproject-9def8.appspot.com/o/stake.jpg?alt=media&token=9ae09525-c15e-411d-8497-5c24af156862");
    ...
    public void writeData(String foodID, String foodName, String foodImg){
        ...
        databaseReference.child("BookMark").child("Food_13").setValue(bookmark);
    }
}
